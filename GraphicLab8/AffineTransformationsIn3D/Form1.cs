...
namespace AffineTransformationsIn3D
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            CurrentDrawable = Models.CubeWithNormals(0.5);
       ...
       /* private void RotateAroundLine(object sender, EventArgs e)
        ...
        private void button8_Click(object sender, EventArgs e)
        {
			if (radioButtonTetrahedron.Checked)
				CurrentDrawable = Models.Tetrahedron(0.5);
			else if (radioButtonIcosahedron.Checked)
				CurrentDrawable = Models.Icosahedron(0.5);
			else if (radioButtonCube.Checked && checkBox1.Checked)
				CurrentDrawable = Models.CubeWithTexture(0.5);
			else
				CurrentDrawable = Models.CubeWithNormals(0.5);
       ...
       /* private void button10_Click(object sender, EventArgs e)
        {
            ...
            CurrentDrawable = Models.RotationFigure(initial, axis, density);
        }*/
        ...
        {
            CurrentDrawable = Models.Plot(-0.8, 0.8, 0.1, -0.8, 0.8, 0.1, F);
        }
        ...
        private void sceneView1_Click(object sender, EventArgs e)
        {

        }

        private void sceneView4_Click(object sender, EventArgs e)
        {
