            ...
            if (Solid)
            {
                ...
                foreach (var facet in Indices)
                    for (int i = 1; i < facet.Length - 1; ++i)
                    {
                        ...
                        var a = new Vertex(Coordinates[facet[0]], Color.DeepSkyBlue);
                        var b = new Vertex(Coordinates[facet[i]], Color.DeepSkyBlue);
                        var c = new Vertex(Coordinates[facet[i + 1]], Color.DeepSkyBlue);
